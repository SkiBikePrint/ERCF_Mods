This allows for purging with blobs and using the hot end silicone jacket to knock the blobs off into a bin.  This is a solution for using Blobifier on a Trident.
